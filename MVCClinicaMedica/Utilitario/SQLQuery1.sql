...
INSERT INTO Pacientes (Nombre, Apellido, Cedula, FechaNacimiento, Edad, EstadoCivil, Direccion, Telefono, Correo) VALUES
('Laura', 'Fernández', '4567890123', '1992-03-25', 29, 'Soltera', 'Calle 456', '111-222-3333', 'laura@example.com'),
('Carlos', 'Ramírez', '5678901234', '1988-08-10', 33, 'Casado', 'Av. 789', '444-555-6666', 'carlos@example.com'),
('Ana', 'López', '6789012345', '2000-01-05', 22, 'Soltera', 'Calle 789', '777-888-9999', 'ana@example.com');
select * from Pacientes;
INSERT INTO HistoriasClinicas (Historial, idPaciente) VALUES
('Historial de Laura Fernández', 1),
('Historial de Carlos Ramírez', 2),
('Historial de Ana López', 3);
...
(120, 2),
(90, 3);
INSERT INTO RegistrosMedicos (Descripcion, idHistoria) VALUES
